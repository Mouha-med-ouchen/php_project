...
<div class="content">
  <svg height="108px" width="108px" viewBox="0 0 128 128" class="loader">
    ...
    <g stroke-dasharray="175.93 351.86" stroke-width="12" stroke-linecap="round">
      <g>
        <rect clip-path="url(#loader-eyes)" height="64" width="128" fill="hsl(21, 89.80%, 50.00%)"></rect>
        <g stroke="hsl(18, 89.80%, 50.00%)" fill="none">
      ...
      <g mask="url(#loader-mask)">
        <rect clip-path="url(#loader-eyes)" height="64" width="128" fill="hsl(59, 89.80%, 50.00%)"></rect>
        <g stroke="hsl(67, 89.80%, 50.00%)" fill="none">
          <circle transform="rotate(180,64,64)" r="56" cy="64" cx="64" class="loader__mouth1"></circle>
          <circle transform="rotate(0,64,64)" r="56" cy="64" cx="64" class="loader__mouth2"></circle>
        </g>
      </g>
    ...
    <script src="../assets/js/produit/loginfron.js"></script>
</body>
</html>